...
$(document).ready(function() {
	...
	$.extend(true, $.magnificPopup.defaults, {
		...
		gallery: {
			tPrev: 'قبلی (فلش چپ)', // Alt text on left arrow
			tNext: 'بعدی (فلش راست)', // Alt text on right arrow
		...
		ajax: {
			tError: '<a href="%url%">محتوا</a> قابل بارگذاری نیست.' // Error message when ajax request failed
		}
	});
